...
var $author$project$App$NavbarMsg = function (a) {
...
var $author$project$App$init = F3(
	function (flags, url, key) {
		var _v0 = $rundis$elm_bootstrap$Bootstrap$Navbar$initialState($author$project$App$NavbarMsg);
		var navbarState = _v0.a;
		var navbarCmd = _v0.b;
		var initialAppState = {key: key, navbarState: navbarState, url: url};
		return _Utils_Tuple2(initialAppState, $elm$core$Platform$Cmd$none);
	});
...
_Platform_export({'App':{'init':$author$project$App$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'serverEndpoint', $elm$json$Json$Decode$string)))({"versions":{"elm":"0.19.1"},"types":{"message":"App.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Bootstrap.Navbar.VisibilityState":{"args":[],"type":"{ visibility : Bootstrap.Navbar.Visibility, height : Maybe.Maybe Basics.Float, windowWidth : Maybe.Maybe Basics.Float, dropdowns : Dict.Dict String.String Bootstrap.Navbar.DropdownStatus }"}},"unions":{"App.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"NavbarMsg":["Bootstrap.Navbar.State"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Bootstrap.Navbar.State":{"args":[],"tags":{"State":["Bootstrap.Navbar.VisibilityState"]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Bootstrap.Navbar.DropdownStatus":{"args":[],"tags":{"Open":[],"ListenClicks":[],"Closed":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Bootstrap.Navbar.Visibility":{"args":[],"tags":{"Hidden":[],"StartDown":[],"AnimatingDown":[],"StartUp":[],"AnimatingUp":[],"Shown":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));