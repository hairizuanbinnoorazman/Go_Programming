...
var $author$project$App$GetShoppingItemListResponse = function (a) {
	return {$: 'GetShoppingItemListResponse', a: a};
};
...
var $author$project$App$ShoppingItemListResp = function (items) {
	return {items: items};
};
...
var $author$project$App$ShoppingItem = F4(
	function (id, name, created, status) {
		return {created: created, id: id, name: name, status: status};
	});
var $author$project$App$shoppingItemDecoder = A3(
	...
	A3(
		...
		A3(
			...
			A3(
				...
				'ID',
				$elm$json$Json$Decode$string,
				$elm$json$Json$Decode$succeed($author$project$App$ShoppingItem)))));
var $author$project$App$shoppingItemListDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'items',
	$elm$json$Json$Decode$list($author$project$App$shoppingItemDecoder),
	$elm$json$Json$Decode$succeed($author$project$App$ShoppingItemListResp));
var $author$project$App$apiListShoppingItems = function (mgrURL) {
	var url = mgrURL + '/api/shopping-list/v1/item';
	return $elm$http$Http$request(
		{
			body: $elm$http$Http$emptyBody,
			expect: A2($elm$http$Http$expectJson, $author$project$App$GetShoppingItemListResponse, $author$project$App$shoppingItemListDecoder),
			headers: _List_Nil,
			method: 'GET',
...
var $author$project$App$Index = {$: 'Index'};
...
var $author$project$App$urlParser = function (ingressPath) {
	return $elm$url$Url$Parser$oneOf(
		_List_fromArray(
			[
				A2(
				$elm$url$Url$Parser$map,
				$author$project$App$Index,
				A2(
					$elm$url$Url$Parser$slash,
					$elm$url$Url$Parser$s(ingressPath),
					$elm$url$Url$Parser$top))
			]));
};
var $author$project$App$urlToPage = F2(
	function (ingressPath, url) {
		return A2(
			$elm$core$Maybe$withDefault,
			$author$project$App$Index,
			A2(
				$elm$url$Url$Parser$parse,
				$author$project$App$urlParser(ingressPath),
				url));
	});
var $author$project$App$init = F3(
	function (flags, url, key) {
		var initialAppState = {
			...
			dialogOpen: false,
			key: key,
			page: A2($author$project$App$urlToPage, flags.ingressPath, url),
			serverSettings: flags,
			shoppingItems: _List_Nil,
			url: url
		};
		return _Utils_Tuple2(
			initialAppState,
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						A2($elm$browser$Browser$Navigation$pushUrl, key, flags.ingressPath + '/'),
						$author$project$App$apiListShoppingItems(flags.serverEndpoint)
					])));
	});
...
var $author$project$App$CreateShoppingItemResponse = function (a) {
	return {$: 'CreateShoppingItemResponse', a: a};
};
...
var $author$project$App$apiCreateShoppingItem = F2(
	function (mgrURL, name) {
		var url = mgrURL + '/api/shopping-list/v1/item';
		var statusBody = $elm$http$Http$jsonBody(
			$elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
		...
		return $elm$http$Http$request(
			{
				body: statusBody,
				expect: $elm$http$Http$expectWhatever($author$project$App$CreateShoppingItemResponse),
				headers: _List_Nil,
				method: 'POST',
				timeout: $elm$core$Maybe$Nothing,
				tracker: $elm$core$Maybe$Nothing,
...
var $author$project$App$ToggleShoppingItem = function (a) {
	return {$: 'ToggleShoppingItem', a: a};
};
var $author$project$App$apiUpdateShoppingItem = F3(
	function (mgrURL, shoppingItemID, status) {
		var url = mgrURL + ('/api/shopping-list/v1/item/' + shoppingItemID);
		var statusBody = $elm$http$Http$jsonBody(
			$elm$json$Json$Encode$object(
				_List_fromArray(
					[
		...
		return $elm$http$Http$request(
			{
				body: statusBody,
				expect: $elm$http$Http$expectWhatever($author$project$App$ToggleShoppingItem),
				headers: _List_Nil,
				method: 'PATCH',
				timeout: $elm$core$Maybe$Nothing,
				tracker: $elm$core$Maybe$Nothing,
...
var $author$project$App$DeleteShoppingItemResponse = function (a) {
	return {$: 'DeleteShoppingItemResponse', a: a};
};
var $author$project$App$apiDeleteShoppingItem = F2(
	function (mgrURL, shoppingItemID) {
		var url = mgrURL + ('/api/shopping-list/v1/item/' + shoppingItemID);
		return $elm$http$Http$request(
			{
				body: $elm$http$Http$emptyBody,
				expect: $elm$http$Http$expectWhatever($author$project$App$DeleteShoppingItemResponse),
				headers: _List_Nil,
				method: 'DELETE',
				timeout: $elm$core$Maybe$Nothing,
				tracker: $elm$core$Maybe$Nothing,
...
var $author$project$App$deleteCmd = F2(
	function (mgrURL, item) {
		return A2($author$project$App$apiDeleteShoppingItem, mgrURL, item.id);
	});
var $author$project$App$deleteCmds = F2(
	function (mgrUrl, items) {
		return A2(
			$elm$core$List$map,
			$author$project$App$deleteCmd(mgrUrl),
			items);
	});
...
var $author$project$App$filterItem = F2(
	function (status, item) {
		return _Utils_eq(item.status, status) ? true : false;
	});
...
var $author$project$App$toggleStatus = F2(
	function (id, shoppingItem) {
		return _Utils_eq(shoppingItem.id, id) ? ((shoppingItem.status === 'active') ? _Utils_update(
			shoppingItem,
			{status: 'in-cart'}) : _Utils_update(
			shoppingItem,
			{status: 'active'})) : shoppingItem;
	});
var $author$project$App$toggleStatusString = function (status) {
	return (status === 'active') ? 'in-cart' : 'active';
};
var $author$project$App$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'UrlChanged':
				var url = msg.a;
				var indexURL = _Utils_update(
					url,
					{path: model.serverSettings.ingressPath + '/'});
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'LinkClicked':
			...
			case 'Clicked':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{dialogItem: '', dialogOpen: true}),
					$elm$core$Platform$Cmd$none);
			case 'Closed':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{dialogItem: '', dialogOpen: false}),
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								A2($author$project$App$apiCreateShoppingItem, model.serverSettings.serverEndpoint, model.dialogItem)
							])));
			case 'ValueChanged':
				var zzz = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						...
						{dialogItem: zzz}),
					$elm$core$Platform$Cmd$none);
			case 'GetShoppingItemListResponse':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var zzz = result.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{shoppingItems: zzz.items}),
						$elm$core$Platform$Cmd$none);
				} else {
					var zzz = result.a;
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'SingleItemClicked':
				var item = msg.a;
				var updatedItems = A2(
					$elm$core$List$map,
					$author$project$App$toggleStatus(item.id),
					model.shoppingItems);
				return _Utils_Tuple2(
					_Utils_update(
						model,
					...
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								A3(
								$author$project$App$apiUpdateShoppingItem,
								model.serverSettings.serverEndpoint,
								item.id,
								$author$project$App$toggleStatusString(item.status))
							])));
			case 'ToggleShoppingItem':
				var result = msg.a;
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'DeleteShoppingItemResponse':
				var result = msg.a;
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'CreateShoppingItemResponse':
				var result = msg.a;
				return _Utils_Tuple2(
					model,
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								$author$project$App$apiListShoppingItems(model.serverSettings.serverEndpoint)
							])));
			default:
				var incartItems = A2(
					$elm$core$List$filter,
					$author$project$App$filterItem('in-cart'),
					model.shoppingItems);
				var deleteCommands = A2($author$project$App$deleteCmds, model.serverSettings.serverEndpoint, incartItems);
				var activeItems = A2(
					$elm$core$List$filter,
					$author$project$App$filterItem('active'),
					model.shoppingItems);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{shoppingItems: activeItems}),
					$elm$core$Platform$Cmd$batch(deleteCommands));
		}
	});
var $author$project$App$ClearClicked = {$: 'ClearClicked'};
var $author$project$App$Clicked = {$: 'Clicked'};
var $author$project$App$Closed = {$: 'Closed'};
var $author$project$App$ValueChanged = function (a) {
	...
	function (config__, content) {
		...
		return A2(
			...
			A2(
				...
				_List_fromArray(
					[
						config_.fullscreen ? A2($aforemny$material_components_web_elm$Material$Dialog$headerElt, config__, content) : $aforemny$material_components_web_elm$Material$Dialog$titleElt(content),
...
var $aforemny$material_components_web_elm$Material$Dialog$alert = F2(
...
var $aforemny$material_components_web_elm$Material$Dialog$defaultAction = A2($elm$html$Html$Attributes$attribute, 'data-mdc-dialog-button-default', '');
...
var $author$project$App$SingleItemClicked = function (a) {
	return {$: 'SingleItemClicked', a: a};
};
...
var $author$project$App$singleShoppingItemRow = function (item) {
	return (item.status === 'active') ? A2(
		...
		A2(
			...
			$author$project$App$SingleItemClicked(item),
...
var $author$project$App$view = function (model) {
	return {
		body: _List_fromArray(
			[
				A2(
				$aforemny$material_components_web_elm$Material$Dialog$alert,
				A2(
					$aforemny$material_components_web_elm$Material$Dialog$setOnClose,
					$author$project$App$Closed,
					A2($aforemny$material_components_web_elm$Material$Dialog$setOpen, model.dialogOpen, $aforemny$material_components_web_elm$Material$Dialog$config)),
				{
					actions: _List_fromArray(
						[
							...
							A2(
								...
								_List_fromArray(
									[$aforemny$material_components_web_elm$Material$Dialog$defaultAction]),
								A2($aforemny$material_components_web_elm$Material$Button$setOnClick, $author$project$App$Closed, $aforemny$material_components_web_elm$Material$Button$config)),
							'Submit')
						]),
				...
				_List_fromArray(
					[
						...
						A2(
						$aforemny$material_components_web_elm$Material$Button$text,
						A2($aforemny$material_components_web_elm$Material$Button$setOnClick, $author$project$App$Clicked, $aforemny$material_components_web_elm$Material$Button$config),
						'Add item'),
						A2(
						$aforemny$material_components_web_elm$Material$Button$text,
						A2($aforemny$material_components_web_elm$Material$Button$setOnClick, $author$project$App$ClearClicked, $aforemny$material_components_web_elm$Material$Button$config),
						'Clear in-cart items'),
						A2(
										...
										A2(
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$text('Shopping Items')
														]))
												])),
										A2($elm$core$List$map, $author$project$App$singleShoppingItemRow, model.shoppingItems))
									]))
							]))
					]))
			]),
			...
			return A2(
				...
				function (ingressPath) {
					return $elm$json$Json$Decode$succeed(
						{ingressPath: ingressPath, serverEndpoint: serverEndpoint});
				},
				A2($elm$json$Json$Decode$field, 'ingressPath', $elm$json$Json$Decode$string));
		},
		A2($elm$json$Json$Decode$field, 'serverEndpoint', $elm$json$Json$Decode$string)))({"versions":{"elm":"0.19.1"},"types":{"message":"App.Msg","aliases":{"App.ShoppingItem":{"args":[],"type":"{ id : String.String, name : String.String, created : String.String, status : String.String }"},"App.ShoppingItemListResp":{"args":[],"type":"{ items : List.List App.ShoppingItem }"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"App.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"Clicked":[],"Closed":[],"ValueChanged":["String.String"],"GetShoppingItemListResponse":["Result.Result Http.Error App.ShoppingItemListResp"],"SingleItemClicked":["App.ShoppingItem"],"ToggleShoppingItem":["Result.Result Http.Error ()"],"DeleteShoppingItemResponse":["Result.Result Http.Error ()"],"CreateShoppingItemResponse":["Result.Result Http.Error ()"],"ClearClicked":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}}}}})}});}(this));